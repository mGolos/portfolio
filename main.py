...
def cv(language="fr"):
    if language == "fr":
        st.markdown("[Télécharger la version française](https://1drv.ms/b/s!Ah3jei6FBtQIhMJLGYXpU8wBcYAe_w)")
        st.markdown("[Télécharger la version anglaise](https://1drv.ms/b/s!Ah3jei6FBtQIhMJeW4W22lFIeqCtBw)")
        st.markdown(
        ...
        st.markdown("[Download the french version](https://1drv.ms/b/s!Ah3jei6FBtQIhMJLGYXpU8wBcYAe_w)")
        st.markdown(
